...
import { Home, Camera, Folder, Edit, Trash, Copy, Scissors, X, Check, Menu, ChevronLeft, MoreVertical, XCircle, Plus, FolderPlus, MessageSquare, Send } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div style={{ 
        ...
        <span style={{ color: "var(--separator-color, #666)" }}>/</span>
        <span style={{ color: "var(--inactive-color, #aaa)" }}>Photos</span>
      </div>
